						...
						if(rs){
								...
								console.log("USUARIO", rs._user);
								 ...
								 var _html = _compiler.render({ _data : { 
								 		...
								 		dias : 30, //rs._credit.data.days[0],
								 		fecha_vencimiento : moment(rs.createdAt).add(30, "days").format('MMMM DD, YYYY'),
								 		...
								 		ip:rs._credit.data.client_metadata.ip ? rs._credit.data.client_metadata.ip : req.ip || 'no definido' ,
